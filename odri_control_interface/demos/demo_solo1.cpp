...
int main()
{
    ...
    auto robot = RobotFromYamlFile(CONFIG_SOLO1_YAML);
    
    std::cout << "demo_solo1.cpp: Define the robot from a yaml file done!" << std::endl;
    robot->Start();
    std::cout << "demo_solo1.cpp: robot->Start(); done!" << std::endl;
    robot->WaitUntilReady();
    std::cout << "demo_solo1.cpp: robot->WaitUntilReady(); done!" << std::endl;
