...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="bolt_controllers_one_joint_motor8_HL_KFE.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="ros2_description_solo12",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="system_solo1_motor8_description.urdf.xacro",
